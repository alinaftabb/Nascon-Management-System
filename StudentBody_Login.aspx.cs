...
public partial class StudentBody_Login : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT username, password FROM StudentExec_login WHERE username = '" + TextBox1.Text + "' AND password = '" + TextBox2.Text + "'", conn);
        ...
        else if (dt.Rows.Count > 0)
        {
            ...
            Response.Redirect("StudentBody_Acc.aspx");
        }
        else
        {
