<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentBody_Login.aspx.cs" Inherits="StudentBody_Login" %>
...
<body>
    ...
    <div class="loginbox">
        ...
        <form id="LogIn_StudentBody" runat="server">
            <h1>Log in to Student Executive  Portal</h1>
            <br />
            <b>Email:</b><br />
