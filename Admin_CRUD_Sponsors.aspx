<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_CRUD_Sponsors.aspx.cs" Inherits="Admin_CRUD" %>
...
<head runat="server">
   <link rel="stylesheet" href="StyleSheet.css" />
    ...
    <title>Administration Portal - Sponsors</title>
</head>
<body> 
        <form id="form1" runat="server">
        <div class="nav">
            <img src="Project.png" class="logo"/>
            <h2>Administration Portal - Sponsors</h2>
        </div>
        ...
        <div class="loginboxx1" >
            <h1>MODIFY</h1>
            <br /><b> Which Sponsor to Modify?</b>
            <asp:TextBox ID="TextBox6" runat="server"  class="input0"></asp:TextBox>
            <br />
            <br /> 
            <b>Company Name</b>
        ...
        <div class="loginboxx3" >
            <h1>DELETE</h1>
            <br /><b> Which Sponsor to Delete?</b>
            <asp:TextBox ID="TextBox13" runat="server"  class="input0"></asp:TextBox>
            <br />
            <br /> 
